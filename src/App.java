public class App {
    public static void main(String[] args) {
        ...
        System.out.println(
                "Resultado burbuja tradicional Metodo 2: " + java.util.Arrays.toString(arregloBurbujaOrdenado2));

        // // // Metodo burbujaTradicionalTercero
        int[] arregloBurbujaOrdenado3 = ordenador.burbujaTradicionalTercero(arregloBurbuja);
        System.out.println(
                "Resultado burbuja tradicional Metodo 3: " + java.util.Arrays.toString(arregloBurbujaOrdenado3));
